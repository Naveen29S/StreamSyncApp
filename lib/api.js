...
export const getInstagramOAuthUrl = ({ redirectUri, clientId, state = 'instagram_oauth' } = {}) => {
  ...
  if (!effectiveClientId || effectiveClientId === '1386754025684618') {
    throw new Error(
      "Meta Developer OAuth requires an official Meta App ID registered in the Meta Developer Portal with Instagram Login for Creators configured. Please enter your Custom App ID below, or use 'Connect via Phyllo' above (which requires 0 Meta setup)."
    );
  }
